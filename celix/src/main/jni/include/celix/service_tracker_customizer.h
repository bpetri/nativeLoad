...
typedef celix_status_t (*adding_callback_pt)(void *handle, service_reference_pt reference,
                                             void **service);

typedef celix_status_t (*added_callback_pt)(void *handle, service_reference_pt reference,
                                            void *service);

typedef celix_status_t (*modified_callback_pt)(void *handle, service_reference_pt reference,
                                               void *service);

typedef celix_status_t (*removed_callback_pt)(void *handle, service_reference_pt reference,
                                              void *service);
...
serviceTrackerCustomizer_create(void *handle,
...
FRAMEWORK_EXPORT celix_status_t
serviceTrackerCustomizer_getHandle(service_tracker_customizer_pt
customizer,
void **handle
);
FRAMEWORK_EXPORT celix_status_t
