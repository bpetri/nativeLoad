...
FRAMEWORK_EXPORT celix_status_t serviceTracker_create(bundle_context_pt context, char *service,
                                                      service_tracker_customizer_pt customizer,
                                                      service_tracker_pt *tracker);

FRAMEWORK_EXPORT celix_status_t serviceTracker_createWithFilter(bundle_context_pt context,
                                                                char *filter,
                                                                service_tracker_customizer_pt customizer,
                                                                service_tracker_pt *tracker);
...
FRAMEWORK_EXPORT service_reference_pt serviceTracker_getServiceReference(
        service_tracker_pt tracker);
...
FRAMEWORK_EXPORT void *serviceTracker_getServiceByReference(service_tracker_pt tracker,
                                                            service_reference_pt reference);

FRAMEWORK_EXPORT void serviceTracker_serviceChanged(service_listener_pt listener,
