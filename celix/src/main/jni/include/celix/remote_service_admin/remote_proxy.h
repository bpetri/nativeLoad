...
typedef celix_status_t (*sendToHandle)(remote_service_admin_pt remote_service_admin_ptr,
                                       endpoint_description_pt endpointDescription, char *request,
...
typedef celix_status_t (*createProxyService)(void *handle,
                                             ...
                                             sendToHandle sendToCallback, properties_pt properties,
                                             void **service);
...
struct remote_proxy_factory_service {
    ...
    celix_status_t (*registerProxyService)(remote_proxy_factory_pt proxyFactoryService,
                                           endpoint_description_pt endpoint,
                                           remote_service_admin_pt remote_service_admin_ptr,
                                           sendToHandle callback);

    celix_status_t (*unregisterProxyService)(remote_proxy_factory_pt proxyFactoryService,
                                             endpoint_description_pt endpoint);
};
