...
struct remote_service_admin_service {
    ...
    celix_status_t (*exportService)(remote_service_admin_pt admin, char *serviceId,
                                    properties_pt properties, array_list_pt *registrations);
    ...
    celix_status_t (*exportReference_getExportedEndpoint)(export_reference_pt reference,
    ...
    celix_status_t (*importRegistration_close)(remote_service_admin_pt admin,
                                               import_registration_pt registration);

    celix_status_t (*importRegistration_getException)(import_registration_pt registration);

    celix_status_t (*importRegistration_getImportReference)(import_registration_pt registration,
