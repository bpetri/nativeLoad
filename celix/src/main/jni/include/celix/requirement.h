...
celix_status_t requirement_create(hash_map_pt directives, hash_map_pt attributes,
...
celix_status_t requirement_isSatisfied(requirement_pt requirement, capability_pt capability,
                                       bool *inRange);
