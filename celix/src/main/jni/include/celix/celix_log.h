...
typedef celix_status_t (*framework_log_function_pt)(framework_log_level_t level, const char *func,
...
FRAMEWORK_EXPORT celix_status_t frameworkLogger_log(framework_log_level_t level, const char *func,
                                                    const char *file, int line, char *fmsg);

FRAMEWORK_EXPORT void framework_log(framework_logger_pt logger, framework_log_level_t level,
                                    const char *func, const char *file, int line, char *fmsg, ...);

FRAMEWORK_EXPORT void framework_logCode(framework_logger_pt logger, framework_log_level_t level,
                                        const char *func, const char *file, int line,
                                        celix_status_t code, char *fmsg, ...);
